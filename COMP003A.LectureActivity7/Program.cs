//Author: Jaime Garcia
//Course: COMP-003A
//Purpose: array and list lecture activity lecture
...
namespace COMP003A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //arrays store a collection of data of the same type (ex. int, string, objects,)
            ...
            //you can set values to an inder using the examples below:
             ...
             * 
             * It is important to nore that arrays cannot be dynamically resized.
            ...
            */
            ...
            //like arrays, lists store a collection of data with the same type(ex int, string, objects,)
            ...
            Console.WriteLine($"Count of the alphabet: {alphabet.Count}"); //displays the count/size of the list; output: 5
        ...
        {
            //you can use for-loop or other looping statements for array traversals
        ...
        static void ArrayTraversal(string array)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            { 
                Console.WriteLine($"Array at the index {i}: {array[i]}");
            }
        ...
        ///<summary>
        ///List traversal using the foreach loop
        /// </summary>
        /// <param name="list">Character list input</param>
        static void ListTraversal(List<char> list)
        {
            //you can use a foreach-loop or other looping statements for list tranversals
